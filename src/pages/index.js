    ...
    <div>
      ...
      <div id="altroots-watch-container">
        <div id="altroots-left">
          ...
          <ul>
            <li>Exact-only Search</li>
            <li>Exact-only annual Watch</li>
            <li>Close similarities Search</li>
            <li>Close similarities annual Watch</li>
          </ul>
        </div>
